                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebaretudients">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="edit-etudient.php" class="nav-link" data-key="t-chat">Modifier un etudient</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebaremployees">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="edit-employees.php" class="nav-link" data-key="t-chat">modifier un employée</a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebartask">
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="list-task.php" class="nav-link" data-key="t-chat"> Liste des tasks </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="add-task.php" class="nav-link" data-key="t-chat">Ajouter un task</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="edit-task.php" class="nav-link" data-key="t-chat">Modifier un task</a>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarecoles">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="edit-ecole.php" class="nav-link" data-key="t-chat">Modifier une école</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebardossiers">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebardossiersetat">
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="list-dossiers-valide.php" class="nav-link" data-key="t-chat"> Dossiers validé</a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    <a href="list-dossiers-annulé  .php" class="nav-link" data-key="t-chat">Dossiers annulé</a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="nav-item">
                                        <a href="edit-dossiers.php" class="nav-link" data-key="t-chat">Modifier un dossier</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
