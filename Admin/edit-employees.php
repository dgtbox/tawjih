                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Modifier des employés</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="list-employees.html">Employés</a></li>
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Modifier les informations de l'employé</h4>
                                </div><!-- end card header -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-4    ">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="firstNameinput" value="nom" >
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" value="prénom" id="lastNameinput">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" value="y888888" id="compnayNameinput">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="tel" class="form-control" value="+(212) 451 45123" id="phonenumberInput">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" class="form-control" value="example@gamil.com" id="emailidInput">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="citynameInput" class="form-label">Genre</label>
                                                        <select type="Genre" class="form-select" value="Male" id="citynameInput">
                                                            <option>Male</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" value="05/01/2000" id="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="emailidInput" class="form-label">Date d'inscription</label>
                                                        <input type="date" class="form-control" value="12/04/2020" id="">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" value="Address" id="address1ControlTextarea">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" value="username" id="address1ControlTextarea">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                                                            <input type="password" class="form-control pe-5 password-input" value="password" id="password-input">
