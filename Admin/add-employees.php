                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Ajouter des employés</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="list-employees.html">Employés</a></li>
                                        <li class="breadcrumb-item active">Ajoute un employé</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Entrer les informations de l'employé</h4>
                                </div><!-- end card header -->
