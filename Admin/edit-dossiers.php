                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Modifier des dossiers</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="list-dossiers.html">Dossiers</a></li>
                                        <li class="breadcrumb-item active">Modifier un dossier</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-xxl-6">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Modifier les informations du dossier</h4>
                                </div><!-- end card header -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-4    ">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="" value="nom" >
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" value="prénom" id="">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select type="Genre" class="form-select" value="1" id="">
                                                            <option>Dossier non validé</option>
                                                            <option>Dossier validé</option>
                                                            <option>Dossier annulé</option>
                                                            <option>Dossier en attendent</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
