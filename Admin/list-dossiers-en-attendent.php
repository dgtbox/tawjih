            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link active" href="#sidebardossiers" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebardossiers">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebardossiersetat">
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="list-dossiers-en-attendent.php" class="nav-link active" data-key="t-chat">Dossiers en attend</a>
                                                </li>
                                                <li class="nav-item">
                                ...
                                <div class="row mb-3 pb-1">
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-20 mb-1">Liste des dossiers en attend</h4>
                                            </div>
