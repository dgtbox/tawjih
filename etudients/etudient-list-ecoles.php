                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        <h6 class="card-title mb-0 flex-grow-1">Écoles déjà envoyées</h6>
                                        ...
                                        <table  class="table align-middle">
                                            ...
                                            <tbody class="list form-check-all">
                                                <tr>
                                                    ...
                                                    <td class="etat-dossier">envoyé </td>
                                                    <td>
                                            ...
                                            <table  class="table align-middle">
                                                ...
                                                <tbody class="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td class="remarque"><span style="color: red;">Il te manque plus d'informations</span></td>
                                                        <td>
                                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                                <a href="javascript:void(0);"><i class="ri-eye-fill align-bottom text-muted"></i></a>
                                                            </li>   
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="etat-dossier">En cours</td>
                                                        <td class="remarque"><span style="color: green;">tes informations sont completes</span></td>
                                                        <td>
                                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                                <a href="javascript:void(0);"><i class="ri-eye-fill align-bottom text-muted"></i></a>
                                                            </li>
                                    ...
                                    <br>
                                    <div class="d-flex mb-3">
                                        <h6 class="card-title mb-0 flex-grow-1">Écoles non envoyées</h6>
                                        <div class="flex-shrink-0">
                                        ...
                                        <table  class="table align-middle">
                                            ...
                                            <tbody class="list form-check-all">
                                                <tr>
                                                    ...
                                                    <td class="etat-dossier">Pas encore ouvert </td>
                                                    <td>
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                            <a href="javascript:void(0);"><i class="ri-eye-fill align-bottom text-muted"></i></a>
                                                        </li>   
